...
const TASKS = [
  ...
  T('sec-3', 'sec', 'SSO standardization plan across SaaS',
    ...
    { status: 'in_progress',
      notes: 'SaaS inventory complete. Tools in scope: QBO, Zoho CRM, Centrally HR, Therap EHR, Star Services LMS, JazzHR (ATS), When I Work (WIW), OSMOR, Slack, Notion. Evaluating Google as IdP for SAML/SSO on each. Therap EHR is highest risk — no SSO today.' }),
  T('sec-4', 'sec', 'MFA enforcement & recovery flow documentation',
    '2026-05-22', ['MS'], ['LC'], 'high',
    { status: 'in_progress',
      notes: 'Phased rollout plan in progress. Phase A (Week 2–3): enforce 2FA on all 7 Super Admin accounts — in progress. Phase B (May 26): Corporate + Leadership (~40 users). Phase C (Jun 9): Direct Care staff (~150+ users). Recovery flow doc being drafted alongside enforcement policy.' }),
  ...
  T('sec-2fa-b', 'sec', '2FA Phase B enforcement — Corporate & Leadership',
    '2026-05-26', ['MS'], ['JE', 'LC'], 'high',
    { status: 'not_started',
      notes: 'Enforce 2FA on ~40 Corporate and Leadership users. Precondition: OU structure in place and recovery flows documented. Comms to go out 1 week before enforcement date.' }),
  ...
  T('sec-2fa-c', 'sec', '2FA Phase C enforcement — Direct Care staff',
    '2026-06-09', ['MS'], ['JE', 'SN'], 'high',
    { status: 'not_started',
      notes: 'Enforce 2FA on ~150+ Direct Care staff. Highest volume and highest change-management risk. Requires device readiness check (personal vs. org device), exception process for shared-device scenarios, and help-desk runbook.' }),
